############################################################
## aux-tar-momentum.R
## Linear Attractor TAR with momentum indicator (Δy-based)
############################################################

# Requires: ic_enders() from aux-utils.R

#-----------------------------------------------------------
# Build TAR regression dataset (momentum-based indicator)
#   dy_l1 = Δy_{t−1}
#   I_t   = 1{ dy_l1 >= 0 }
#-----------------------------------------------------------
...
#-----------------------------------------------------------
# Estimate linear attractor TAR (momentum indicator)
#   Same tests as level version
#-----------------------------------------------------------
