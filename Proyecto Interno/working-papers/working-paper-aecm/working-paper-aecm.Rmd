...
```{r table7_only_four_foods, echo=FALSE, results="asis", warning=FALSE, message=FALSE}
library(stringr)
library(knitr)
library(kableExtra)
...
# ---- This prints headings + tables directly in the Rmd ----
for (nm in names(tables_12)) {

  if (any(str_detect(nm, fixed(alimentos_keep)))) {
