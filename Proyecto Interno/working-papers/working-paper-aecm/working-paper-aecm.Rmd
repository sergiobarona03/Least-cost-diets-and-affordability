...
Para el modelo TAR con umbral fijo $\tau = 0$, el número óptimo de rezagos seleccionado mediante el criterio BIC es $p = 1$. 
Los coeficientes de ajuste estimados son $\rho_1 = -0.3294$ ($t = -3.30$) cuando $\mu_{t-1} \ge 0$ y $\rho_2 = -0.2607$ ($t = -2.29$) cuando $\mu_{t-1} < 0$.
...
Para el modelo M-TAR con umbral estimado $\tau=\hat{\tau}=0.09108$, el número óptimo de rezagos seleccionado mediante el criterio BIC es $p=1$.
Los coeficientes de ajuste estimados son $\rho_1=-0.2903$ ($t=-1.80$) cuando $\Delta\mu_{t-1}\ge\hat{\tau}$ y $\rho_2=-0.3024$ ($t=-3.51$) cuando $\Delta\mu_{t-1}<\hat{\tau}$.

Para el modelo M-TAR momentum con umbral fijo $\tau = 0$, el número óptimo de rezagos seleccionado mediante el criterio BIC es $p = 1$. Los coeficientes de ajuste estimados son $\rho_1 = -0.3241$ ($t = -2.915$) cuando $\Delta\mu_{t-1} \ge 0$ y $\rho_2 = -0.2788$ ($t = -2.891$) cuando $\Delta\mu_{t-1} < 0$.
