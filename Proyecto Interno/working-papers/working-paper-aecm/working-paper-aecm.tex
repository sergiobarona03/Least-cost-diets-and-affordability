...
\urlstyle{same}
\hypersetup{
  pdftitle={Transmisión de precios y ajuste asimétrico al equilibrio: evidencia para las principales ciudades de Colombia mediante modelos de corrección de error},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{\textbf{Transmisión de precios y ajuste asimétrico al
equilibrio:\\
evidencia para las principales ciudades de Colombia mediante\\
modelos de corrección de error}}
\author{\textbf{Proyecto 5.271}\\
``Análisis sobre la asequibilidad de los hogares urbanos a dietas\\
de costo mínimo para tres ciudades principales de Colombia\\
...
La transmisión de precios entre el nivel mayorista y el minorista ha
sido ampliamente estudiada en la literatura de organización industrial y
economía agrícola, pero la evidencia para Colombia sigue siendo
limitada, especialmente a nivel de ciudades y productos específicos.
Este documento estima modelos de corrección de error simétricos y
asimétricos para siete alimentos básicos en Bogotá, Medellín y Cali
durante el período 2013--2024, combinando datos de precios minoristas
del IPC (DANE) y precios mayoristas del SIPSA. El objetivo es
identificar si los ajustes al equilibrio de largo plazo entre ambos
niveles de precios difieren según el signo y la dirección del
desequilibrio, lo que constituiría evidencia de asimetría en la
