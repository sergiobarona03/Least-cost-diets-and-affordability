---
title: "Documento de trabajo 1225: Metodología para la predicción de los precios minoristas de los alimentos localmente disponibles en las principales ciudades de Colombia"
...
knitr::include_graphics(
  paste0(
    directorio_base,
    "/working-papers/working-paper-1225/m4/Imagen1.png"
  )
)
```
...
knitr::include_graphics(
  paste0(
    directorio_base,
    "/working-papers/working-paper-1225/m4/Imagen2.png"
    )
)
```
