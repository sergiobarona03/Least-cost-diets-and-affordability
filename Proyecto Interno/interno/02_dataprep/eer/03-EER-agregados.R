########################################################
## SCRIPT 02_dataprep/eer/03-EER-agregados.R
## Une los EER de niños/adolescentes (01-EER-ninos.R) y de
## adultos (02-EER-adultos.R) en una sola base por ciudad, y
## arma la tabla/figura del Appendix B en LaTeX.
##
## Reads:  output_dir/230726_child_eer.xlsx
##         output_dir/230726_adult_eer.xlsx
## Writes: output_dir/230726_agg_eer.xlsx
##         output_dir/appendix_B_eer.tex
########################################################
...
writexl::write_xlsx(
  agg_eer,
  file.path(output_dir, "230726_agg_eer.xlsx")
)
...
writeLines(
  ...
  file.path(output_dir, "appendix_B_eer.tex")
)
