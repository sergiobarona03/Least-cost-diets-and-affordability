########################################################
## SCRIPT v1/02_dataprep/01_panel_mensual_tcac.R
...
## calculado desde v1/01_webscrap_prep/01_construccion_panel.R),
## lo agrega a nivel MENSUAL (mediana entre las fechas de
## scraping del mes) y lo cruza con la composicion nutricional
## TCAC (output de 00_tcac_composicion.R) para calcular precio
## por 100g de porcion comestible.
##
## Reads:  v1_output_dir/paneles/panel_balanceado.rds
##         v1_output_dir/tcac/composicion_270726.rds
## Writes: v1_output_dir/paneles/panel_mensual_cities_tcac.rds
...
ruta_panel_v2 <- file.path(v1_output_dir, "paneles/panel_balanceado.rds")
ruta_tcac     <- file.path(v1_output_dir, "tcac/composicion_270726.rds")
...
saveRDS(
  ...
  file.path(v1_output_dir, "paneles/panel_mensual_cities_tcac.rds")
)

cat("\nListo. panel_mensual_cities_tcac.rds guardado en", v1_output_dir, "\n")
