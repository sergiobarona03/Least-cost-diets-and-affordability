########################################################
## SCRIPT v1/01_webscrap_prep/02b_panel_balanceado.R
## Version v1: mismo script que el pipeline en produccion, leyendo
## y escribiendo dentro de v1/output/ en vez de output/.
##
