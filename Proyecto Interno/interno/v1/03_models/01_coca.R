...
## Las funciones auxiliares (CoCA_paper.R) y el EER por hogar no
## dependen del metodo de precio, se reutilizan del proyecto real.
##
...
message("Done. Run v1/03_models/02_cona.R next.")
