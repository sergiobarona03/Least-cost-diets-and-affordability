...
alimentos_excluir <- c(
  ...
  "MANTECA VEGETAL",
  "MANTEQUILLA",
  "MELOCOTONES O VARIEDAD DISPONI",
  "MELOCOTONES O VARIEDAD DISPONIBLE",
  "PAN CORRIENTE",
  "PAN FRANCÉS",
  "PAN INTEGRAL",
  "PASTA PARA SOPA",
...
readr::write_csv(retail_99_18,
                 "estimadores-banrep/CALI/DANE/input/v3/v3_retail_price_data.csv")
...
readr::write_csv(input_cali_hat2,
                 "estimadores-banrep/CALI/DANE/input/v3/v3_comp_price_data_cali.csv")
