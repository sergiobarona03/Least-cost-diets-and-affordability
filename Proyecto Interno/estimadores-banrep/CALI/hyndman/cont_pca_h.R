########################################################
## Prueba: Contribuciones del PCA 99_18               ##
########################################################
...
# Cargar códigos
source("estimadores-banrep\\CALI\\hyndman\\input_pca_h.R")
...
# Guardar en Excel
write_xlsx(hojas_excel, "estimadores-banrep\\CALI\\hyndman\\resultados_pca_h.xlsx")