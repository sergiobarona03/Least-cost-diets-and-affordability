---
title: "Estimación de precios minoristas de alimentos con contribuciones PCA"
...
# Antes del bucle, recuperar las contribuciones a la variabilidad total
var_ipc_base = readxl::read_excel("var-ipc\\IPC.xls") %>% janitor::clean_names()
...
################################################
################################################
### Pasos para calcular el parámetro de ajuste
...
# Cargar resultados
setwd("C:\\Users\\Portatil\\Desktop\\Least-cost-diets-and-affordability\\Proyecto Interno\\")
resultados_metricas = read.csv("pca_300725_resultados_metricas_ipc.csv")
